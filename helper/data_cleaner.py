...
def filter_stocks_data(stocks_data: list)->list[dict[str,str]]:
    filtered_stocks_data = []
    for stock_data in stocks_data:
        filtered_stock_data = {}
        filtered_stock_data['symbol'] = stock_data['symbol']
        filtered_stock_data['symbol'] = stock_data['symbol']
        ...
        filtered_stocks_data.append(filtered_stock_data)
    return filtered_stocks_data
        

def get_clean_stocks_data(response: str) -> dict[str,dict[str,list]]:
